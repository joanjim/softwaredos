...
th {
  ...
  <body>
    ...
    <div class="page">
      <!-- Page Header-->
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/Imagenes/z16.jpeg);">
        <div class="container">
          <h1 class="breadcrumbs-custom-title">LISTA DE LIBROS</h1>
          <pre-footer-classic class="breadcrumbs-custom-subtitle">Esta sección encontraras todos los libros registrados en el sistema IESMA.</pre-footer-classic>
        </div>
      </section>
      <!-- Base typography -->
		<center>
	...
	<table border="1">
		<tr>
		 ...
		 <th><center>Nombre del Libro</center></th>
		 <th><center>Cantidad</center></th>
		</tr>
	<?php
		include("abrir_conexion.php");
		$resultados = mysqli_query($conexion,"SELECT * FROM libros");
		while($consulta = mysqli_fetch_array($resultados))
		{
	?>
		<tr>
		 <td><center><?php echo $consulta['cod_lib'] ?></center></td>
		 <td><center><?php echo $consulta['desp'] ?></center></td>
