...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/Imagenes/z34.jpg);">
        <div class="container">
          <h3 class="breadcrumbs-custom-title">¡EXITO AL GUARDAR EL ROL!</h3>
          <pre-footer-classic class="breadcrumbs-custom-subtitle"></pre-footer-classic>
        </div>
      </section>
      <!-- Base typography -->
		...
		?>
		  <center>
                  <h3>NUEVO ROL AGREGARO CORRECTAMENTE</h3>
		  
			<?php
			error_reporting(0);
			include("abrir_conexion.php");
			$insertar = "INSERT INTO asignador VALUES ('$CUSU','$CROL')";
