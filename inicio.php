...
input[type=button], input[type=submit], input[type=reset] {
 ...
 <div class="col-lg-6">
		...
		?>
			...
			<form action="" method="POST">
 			<div class="col-lg-4">
                	<div class="form-wrap form-wrap-icon">
                  	...
                  	<label class="form-label" for="contact-usu">Usuario</label>
			<div class="form-wrap form-wrap-icon">
			...
			<p></p>
			<a class="button button-default" href="registrarse.php">REGISTRARSE</a>
...
<?php
		...
		$resultados2 = mysqli_query($conexion,"SELECT * FROM usuario WHERE usuario = '".$usu."' AND contrasena = '".$con."'");
		$nr = mysqli_num_rows($resultados2);
		if($nr==1){
