...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="adminMENU.php">Inicio</a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/Imagenes/z31.jpg);">
        <div class="container">
          <h3 class="breadcrumbs-custom-title">¡EXITO AL BORRAR!</h3>
          <pre-footer-classic class="breadcrumbs-custom-subtitle">Toda la información del el usuario ha sido borrada dentro del sistema.</pre-footer-classic>
        </div>
      </section>
      <!-- Base typography -->
		...
		?>
		  <center>
                  <h3>USUARIO ELIMINADO SATISFACTORIAMENTE</h3>
		  
			<?php
			error_reporting(0);
			include("abrir_conexion.php");
			$insertar = "DELETE usuario FROM usuario WHERE Cod_usu = '".$eli."'";
		...
		<p></p><p></p>
		<center><a class="button button-default" href="adminMENU.php">VOLVER</a></center>
		<p></p><p></p>
      <!-- Page Footer-->
